...
**Always lead with a draft answer derived from the paper**, then ask the author to correct, sharpen, or replace it. Format as:

> *Draft (from paper):* [your inferred answer]
> *Does this capture it, or would you put it differently?*

Offer two alternatives when the draft answer could go in genuinely different directions. Label them A and B. Do not offer more than two — choices multiply faster than clarity.
