...
- `polarization_reciprocal`: **PASS**.
- `coupling_lesion`: **PASS**.
- `exiling`: **PASS**.
- `false_exiling`: **PASS**.
- `alternatives`: **PASS**.
- `registration`: **PASS**.
- `befriending`: **PASS**.
- `partial_partner_support`: **PASS**.
- `coalition_mediator`: **PASS**.
- `two_to_three_scaling`: **PASS**.
- `reduction_composition`: **PASS**.
- `historical_context`: **PASS**.
