...
| 2 | 0.25 | 2 / 16 | 0.1250 | [0.0350, 0.3602] | 0.1458 |
| 3 | 0.50 | 2 / 16 | 0.1250 | [0.0350, 0.3602] | 0.1458 |
| 4 | 0.75 | 3 / 16 | 0.1875 | [0.0659, 0.4301] | 0.1458 |
| 5 | 1.00 | 1 / 16 | 0.0625 | [0.0111, 0.2833] | 0.0625 |

Shape verdict: **FAIL** (isotonic permutation p = 0.4946).
...
| 2 | 4 / 4 | 1.0000 | [0.5101, 1.0000] | FAIL |
| 3 | 0 / 10 | 0.0000 | [-0.0000, 0.2775] | PASS |
| 4 | 4 / 6 | 0.6667 | [0.3000, 0.9032] | FAIL |
| 5 | 4 / 6 | 0.6667 | [0.3000, 0.9032] | FAIL |

Test 2 verdict: **FAIL**.

## Test 3 — continuity

The exact frozen p99 bound was `0.097067115510` (reported freeze value `0.097067`); the challenge hard maximum was `1.75 × p99 = 0.169867452143`. 0/492 acute slices exceeded p99 (0.000000; limit 0.015). The maximum change over all slices was 0.085432174281.

Test 3 verdict: **PASS**.

## Test 4 — persistence and mediation

The replay arm selected 6 formed low-control matched pairs (required at least 40). The available-minus-replay end persistent-evidence-margin effect was -0.200573, 95% paired interval [-0.965961, 0.564815].

End persistence versus the realized action/transition-only mediator: r = 0.5050, 95% interval [-0.0970, 0.8365]. Scheduled dose after conditioning on the mediator: partial r = -0.6712, 95% interval [-0.8989, -0.1583].
...
This is the authorized V2.3.1r instrument repeat. The original defective-instrument C-V23b verdict remains at `results/challenges/C-V23b/` and is not overwritten. The repair changes only candidate evidence normalization; the frozen parameters, protocol, seeds, stream family, thresholds, and p99 reference are unchanged.
