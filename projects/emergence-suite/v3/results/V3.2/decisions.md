...
1. The five V2.4 temporal descriptions are posterior-region readouts over
   generic productions, not candidate labels.
2. The two typed parameter blocks may independently select scope and dynamics,
   which natively represents mixed temporal parents.
