...
## C-V36C revealed and escrow released (2026-08-03)
C-V36C plaintext revealed to projects/emergence-suite/v3/sealed-revealed/C-V36C-mixed-temporal-challenge.md; sha256 verified against the sealed record (c958ea84...). Escrow 4120000:4122999 is RELEASED by this record for exactly one challenge execution per the sealed parse instruction. Immutable verdict before interpretation; traces persisted and hashed before criteria. Final seal of the V3.6 set.

## C-V36C executed; final v3 profile published (2026-08-03)
C-V36C ran exactly once on released escrow 4120000:4122999 (3,000 seeds, ascending, gap-free, event ledgers persisted and hashed before criteria; raw trace sha256 835f4a56...). Immutable verdict: PASS on all criteria — context scoping +0.9719 [0.9662, 0.9771], witnessing/broadcast +0.4558 [0.4468, 0.4645], contact-outcome pathway +0.1188 [0.1012, 0.1353], stakes policy +0.1046 [0.1032, 0.1060], stakes scientific-posterior identity exactly 0, custody clean. All three V3.6 sealed challenges are now PASS (A, B, C). The final v3 profile is published (results/V3.6/v3-final-profile.md/.json): full ladder C-V30..C-V36C, tournament Pareto vector verbatim (context PASS; identity/outcome/partner/contact FAIL retained), gates (retained apparatus stop + replacement PASS + amended gate 5), Populations A-R1/B/C, every retained stop and barred block enumerated, internal rounds 16-19 labeled. No softening.

## External round 24: retroactive review + T-V3-DO2 authorization (2026-08-03)
GPT-5.6 Pro reviewed internal rounds 16-23 (verbatim rulings: results/V3.6/external-round24-rulings.md). Verdict: INTERNAL_ROUNDS_16_23_RETROACTIVELY_REVIEWED - ALL EXECUTION RULINGS RATIFIED - ROUND_22_CLASSIFICATION_WORDING_AMENDED - DIRECT_LOCALIZATION_PRECEDENT_LIMITED_TO_NONSCIENTIFIC_VERIFIERS. No reversal, seed invalidation, challenge invalidation, or rerun required. Tournament interpretation endorsed with binding paper-facing refinements ("compression redistributed predictive capacity"; capacity-omission vs complexity-cost; narrow competing-explanations wording for danger). Organism lineage frozen for the paper at V3.6 (validated compressed organism) + V3.7 (prospectively predicted capacity probe); further augmentation only as a separately named registered 2x2 study, not before the paper. T-V3-DO1 retained as FAIL_APPARATUS_PACING_UNATTAINABLE / SCIENTIFIC_TIMING_CRITERIA_NOT_EVALUATED (the evaluator's "fast evidence uptake" gloss is retired). T-V3-DO2 AUTHORIZED once: dimensionless nonsaturation construct (interior crossing 0.40T-0.65T median, early floor, 0.60-0.90 endpoint range, spread, event availability, detectable opportunity >= 4 slices), fresh grid over T in {64,96,128}, apparatus-only qualification 5200000:5203999, main 5210000:5229999 + escrow 5300000:5305999 reserved; if no schedule qualifies the do-over program closes as TWO_PROSPECTIVE_PACING_DESIGNS_UNABLE_TO_ESTABLISH_DYNAMIC_RANGE with no DO3. Four permanent defenses added: full-path generator/scorer identity, typed forecast-semantics manifest, proof-dependency and scope ledger, relabeling/metamorphic invariance.

## T-V3-DO2 executed; do-over timing program CLOSED (2026-08-04)
Round-24 defenses A-D implemented and PASS (full-path generator/scorer identity, typed forecast-semantics manifest, proof-dependency ledger, metamorphic invariance; records under results/V3.6/round24-defenses/). T-V3-DO2 pacing qualification ran once on fresh apparatus-only block 5200000:5203999 (ascending, gap-free, trace sha256 63caf434...): all 108 schedules across T in {64,96,128} evaluated under the dimensionless nonsaturation construct; NO schedule qualified. The binding constraint was detectable opportunity: required >= 0.80 of eligible worlds with T_M_baseline - t_post >= 4; maximum attained 0.001473. Per external round-24 ruling 4.4 the program closes as TWO_PROSPECTIVE_PACING_DESIGNS_UNABLE_TO_ESTABLISH_DYNAMIC_RANGE. No DO3. No imagery, do-over, main, or escrow block was ever opened; no timing criterion was ever evaluated in either design. Reserved blocks 5210000:5229999 and 5300000:5305999 are retired unconsumed.

## External round 25: decisive-tests program; registered predictions sealed (2026-08-04)
GPT-5.6 Pro reviewed the evaluator's proposed decisive tests (verbatim: results/decisive-tests/external-round25-rulings.md) and refined them into three serial studies; Brent authorized design and execution. Binding corrections adopted: trust/permission/descent/identity are NOT unitary claims (each = supported behavioral result + open mechanistic interpretation); permission re-phrased as q(pi_permit) under the named posteriors; interim Appendix-A standings adopted (protector trust supported under sealed composed challenge; permission graded/revocable-posterior interpretation untested; descent autonomous selection untested; identity-as-posterior pending code audit; refusal and rupture asymmetry untested). Registered predictions for all three studies SEALED together pre-implementation (results/decisive-tests/registered-predictions.md): DT-S1-IDGEN (code audit gate, BF-calibrated identity-first ordering with exposure-rational control, root-lesion transfer table, identity-share x similarity double dissociation vs associative comparator, real-danger negative control), DT-S2-DESCENT (two-agent controller-system game, oracle-verified non-IFS-optimal control cells, deadlock factorial with minimal-sufficient-set claim, bypass/backlash), DT-S3-PERMISSION (clamp decomposition with exact-zero identity, co-protection x safety with danger probe, refusal-EIG partial association, diagnosticity-controlled revocation with symmetric-model control). Blocks: S1 3790000:3799999, S2 3800000:3811999, S3 3812000:3819999. Frozen v3.6 scientific modules untouched; all new code is apparatus/comparator/controller, enumerated per design freeze; full defense battery incl. round-24 A-D pre-block.

## DT-S1-IDGEN executed (2026-08-04)
Study 1 ran once within 3790000:3799999 (10,000/10,000 seeds, ascending, gap-free; trace sha256 bcd3feba...; full defense battery incl. round-24 A-D PASS; frozen v3.6 scientific sources unchanged; one seed-free formatter repair disclosed). Immutable verdict PASS; 9/10 sealed prediction rows met; 0 falsifiers triggered. CODE AUDIT: standing 2 — identity revision proceeds by ordinary inference (no authored update), but cue transfer is routed through an authored shared-root dependency; S1-B/C therefore labeled architecture-conditional per the sealed rule; the not-met row was the evaluator's standing-3 prediction. S1-A: identity-first ordering 2000/2000 in identity-coupled worlds AND outcome-first 2000/2000 in exposure-rational control worlds (BF-calibrated equivalent thresholds; ordering is evidence-driven, not built in). S1-B (architecture-conditional): full model treated 0.466/untreated 0.506; root-sharing lesion untreated exactly 0.0 with treated preserved bitwise; cue-local removed both 0.0 — the registered three-row table exactly. S1-C (architecture-conditional): double dissociation — v3.6 identity-share effect 0.499 vs similarity 0.0; associative comparator similarity 0.465 vs identity-share 0.0. S1-D: identity posterior separates all four danger families (majority-mass 0.85/1.00/0.72/0.96) with near-zero part-mass in pure-external (0.0013) and acute (0.0015) — no identity pathology inferred from persistent external danger.

## DT-S2-C replacement + DT-S3-PERMISSION executed; decisive-tests program complete (2026-08-04)
S2-C replacement ran once on 3820000:3823999 (runner repair audited; estimand-conformance proof now permanent; 4,000 worlds, custody clean, trace sha256 aa555738...). Immutable verdict FAIL_RETAINED on one of four criteria: forced contact raises protector pressure (+0.758 log-odds vs permission-first) and reduces later contact (-1.293) with the low-permission arm intermediate (+0.167/-0.347) — the bypass/backlash core is MET and the no-difference falsifier not triggered; but refusal-respecting retreat did NOT preserve access (-0.0268 vs the low arm, beyond the log(1.02) ROPE; information-seeking +0.018 within ROPE) — the retreat-preserves row is scored not met and retained. DT-S3-PERMISSION ran once within 3812000:3819999 (8,000 worlds, custody clean): PASS on all rows — clamp decomposition confirms every named posterior moves q(pi_permit) in its signed direction and the full-clamp identity is exactly zero (no hidden route); durable permission under the danger probe tracks co-protection (+0.0466 beyond ROPE); refusal probability tracks EIG with safety and cost held constant (partial coefficient +1.343); revocation asymmetry present under the failure-diagnostic partner model (0.1836) and exactly 0.0 under the symmetric control — the asymmetry is inferential. 108/108 tests; frozen scientific modules unchanged throughout. The round-25 decisive-tests program is COMPLETE: S1 9/10 rows, S2-A/B confirmed with S2-C core confirmed + one retained miss, S3 full pass.

## T-CAP1 CLOSED (2026-08-04)
Census-3 executed once (12,000 worlds, 486 cells incl. pre-committed extension, block 3848000:3859999, custody clean, trace sha256 6d2ac754...; coupling-zero counterfactual identity EXACT in all applicable worlds). Mechanical classification: 0 material-metastability / 206 weak / 268 null / 12 pathological; world-level fingerprint rate 0.0000 in every selected cell; no preregistered epsilon/k recovery candidate reached 0.80 (max 0.652); seal eligibility failed 5/6 clauses. Round-30 stop rule executed: T-CAP1 CLOSED - BISTABILITY NOT SUPPORTED - CALIBRATION-BASED METASTABILITY NOT ATTAINABLE - NO CONFIRMATORY SEAL. Two negative dynamics findings retained with binding scope; reserved confirmatory 3832000:3839999 and escrow 4130000:4132999 retired unconsumed; no census-4. Closure record: results/decisive-tests/tcap1-closure.md.
